...
\n\t Copyright 1995 - 1999, -egs-, all rights reserved.. \n\n";
...
{  
    ...
    // char ss_filename[25] = "c:\\ss\\ss_patterns.dat";       /* disulfide database name */
...
//    int myindex;
    ...
    printf("Disulfide database used: %s\n",ss_filename);
