...
void CV3Space::SetDataPath(LPCTSTR propVal)
{
...
BOOL CV3Space::copyCamera(long nDstId, long nSrcId)
{
	BOOL result;
	static BYTE parms[] =
		VTS_I4 VTS_I4;
...
long CV3Space::createPerspectiveCamera(LPCTSTR lpszCameraName)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR;
...
BOOL CV3Space::deleteCamera(long nCameraId)
{
	BOOL result;
	static BYTE parms[] =
		VTS_I4;
...
float CV3Space::getCameraAspectRatio(long index)
{
	float result;
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x55, DISPATCH_METHOD, VT_R4, (void*)&result, parms,
		index);
	return result;
}

float CV3Space::getCameraFarDistance(long index)
{
	float result;
	static BYTE parms[] =
		VTS_I4;
...
float CV3Space::getCameraFocalDistance(long index)
{
	float result;
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x57, DISPATCH_METHOD, VT_R4, (void*)&result, parms,
		index);
	return result;
}

float CV3Space::getCameraHeight(long index)
{
	float result;
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x5a, DISPATCH_METHOD, VT_R4, (void*)&result, parms,
		index);
	return result;
}

float CV3Space::getCameraNearDistance(long index)
{
	float result;
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x58, DISPATCH_METHOD, VT_R4, (void*)&result, parms,
		index);
	return result;
}

CString CV3Space::getCameraName(long nCameraId)
{
	CString result;
	static BYTE parms[] =
		VTS_I4;
...
void CV3Space::getCameraOrientation(long nCameraId, float* fAxisX, float* fAxisY, float* fAxisZ, float* fAngleRad)
{
	static BYTE parms[] =
		VTS_I4 VTS_PR4 VTS_PR4 VTS_PR4 VTS_PR4;
	InvokeHelper(0x66, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		 nCameraId, fAxisX, fAxisY, fAxisZ, fAngleRad);
}

void CV3Space::getCameraPosition(long nCameraId, float* fX, float* fY, float* fZ)
{
	static BYTE parms[] =
...
long CV3Space::getCameraType(long index)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
float CV3Space::getLightDropOffRate(long lLightId)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0x9d, DISPATCH_METHOD, VT_R4, (void*)&result, parms,
		lLightId);
	return result;
}
...
long CV3Space::getNextCamera(long lCameraId)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
{
	float result;
	InvokeHelper(0x4a, DISPATCH_METHOD, VT_R4, (void*)&result, NULL);
	return result;
}
...
{
	BOOL result;
	InvokeHelper(0xaa, DISPATCH_METHOD, VT_BOOL, (void*)&result, NULL);
	return result;
}
...
void CV3Space::pointCameraAt(long nCameraId, float fX, float fY, float fZ)
{
	static BYTE parms[] =
...
void CV3Space::setCameraAspectRatio(long nCameraId, float faspectRatio)
{
	static BYTE parms[] =
		VTS_I4 VTS_R4;
	InvokeHelper(0x61, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		 nCameraId, faspectRatio);
}

void CV3Space::setCameraFarDistance(long nCameraId, float fDist)
{
	static BYTE parms[] =
		VTS_I4 VTS_R4;
...
void CV3Space::setCameraHeight(long nCameraId, float fHeight)
{
	static BYTE parms[] =
		VTS_I4 VTS_R4;
...
void CV3Space::setCameraNearDistance(long nCameraId, float fDist)
{
	static BYTE parms[] =
		VTS_I4 VTS_R4;
...
void CV3Space::setCameraOrientation(long nCameraId, float fAxisX, float fAxisY, float fAxisZ, float fAngleRad)
{
	static BYTE parms[] =
...
void CV3Space::setCameraPosition(long nCameraId, float fX, float fY, float fZ)
{
	static BYTE parms[] =
		VTS_I4 VTS_R4 VTS_R4 VTS_R4;
...
void CV3Space::setCameraScaleHeight(long nCameraId, float fHeight)
{
	static BYTE parms[] =
		VTS_I4 VTS_R4;
...
void CV3Space::setCurrentCamera(long lCameraId)
{
	static BYTE parms[] =
		VTS_I4;
...
void CV3Space::setCameraName(long lCameraId, LPCTSTR lpszCamNam)
{
	static BYTE parms[] =
		VTS_I4 VTS_BSTR;
	InvokeHelper(0x83, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		 lCameraId, lpszCamNam);
}
...
BOOL CV3Space::validateCameraId(long lCameraId)
{
	BOOL result;
	static BYTE parms[] =
		VTS_I4;
...
LPDISPATCH CV3Space::getLightManipIDispatch(long nLightId)
{
	...
	static BYTE parms[] =
		VTS_I4;
	InvokeHelper(0xce, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms,
		nLightId);
	return result;
}
...
BOOL CV3Space::isValidCameraId(long nCameraId)
{
	BOOL result;
	static BYTE parms[] =
		VTS_I4;
...
void CV3Space::dollyCamera(long nCameraId, double interval, BOOL dollyCameraComplete)
{
	static BYTE parms[] =
